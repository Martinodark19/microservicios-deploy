package com.example.kafka_server.config;
...
{
     @Bean
    public NewTopic topicUsuarioEventsRequest() {
        ...
        NewTopic newTopic = TopicBuilder.name("usuarioEventsRequest-topic")
                .partitions(5) // Numero de particiones
    ...
    @Bean
    public NewTopic topicUsuarioEventsResponse() {
        ...
        NewTopic newTopic = TopicBuilder.name("usuarioEventsResponse-topic")
                .partitions(5) // Numero de particiones
                .replicas(1) // Numero de replicas
                .configs(configurations)
                .build();
